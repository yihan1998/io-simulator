...
CSV_HEADER = "Run ID,Cores,Sim Duration,Load,CPU Load,Task Load," \
             ...
             "Total Average Latency,Total Median Latency,Total 90% Latency,Total 95% Latency,Total 99% Tail Latency,Total 99.9% Tail Latency"
...
def analyze_sim_run(name, run_name, output_file, print_results=False, time_dropped=0):
    ...
    total_percentiles = np.percentile(task_total_latencies, [50, 90, 95, 99, 99.9])
    ...
    data_string = "{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}".format(
        ...
        np.average(task_total_latencies), total_percentiles[0], total_percentiles[1], total_percentiles[2], total_percentiles[3], total_percentiles[4],  
